...
public class StressApplication {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("spring.profiles.active", "stress");
        Logger log = LoggerFactory.getLogger(StressApplication.class);
        ...
        try {
            applicationContext = new AnnotationConfigApplicationContext(StressApplication.class) {
                @Override
