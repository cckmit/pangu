...
public class FieldDef implements Comparable<FieldDef> {
	...
	public static FieldDef valueOf(int code, String name, Type type, Method fastGet, Method fastSet) {
	...
	public static FieldDef valueOf(int code, String name, Type type, Field field) {
		FieldDef e = new FieldDef();
		e.name = name;
		e.type = type;
		e.code = code;
