...
public class IndexedTreeMap<K, V> extends AbstractMap<K, V> implements IndexedNavigableMap<K, V>, Cloneable,
	...
	static final class KeySet<E> extends AbstractSet<E> implements NavigableSet<E> {
		...
		public NavigableSet<E> subSet(E fromElement, boolean fromInclusive, E toElement, boolean toInclusive) {
			return new IndexedTreeSet<E>(m.subMap(fromElement, fromInclusive, toElement, toInclusive));
		}
	...
	static <K, V> Map.Entry<K, V> exportEntry(IndexedTreeMap.Entry<K, V> e) {
		return e == null ? null : new java.util.AbstractMap.SimpleImmutableEntry<K, V>(e);
	}
	...
	static abstract class NavigableSubMap<K, V> extends java.util.AbstractMap<K, V> implements NavigableMap<K, V>,
			java.io.Serializable {
		/**
		 * The backing map.
		 */
		...
		final IndexedTreeMap.Entry<K, V> absLowest() {
			IndexedTreeMap.Entry<K, V> e = (fromStart ? m.getFirstEntry() : (loInclusive ? m.getCeilingEntry(lo) : m
					.getHigherEntry(lo)));
			return (e == null || tooHigh(e.key)) ? null : e;
		}

		final IndexedTreeMap.Entry<K, V> absHighest() {
			IndexedTreeMap.Entry<K, V> e = (toEnd ? m.getLastEntry() : (hiInclusive ? m.getFloorEntry(hi) : m
					.getLowerEntry(hi)));
